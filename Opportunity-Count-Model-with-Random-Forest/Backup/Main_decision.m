...
for i = 1%:N
    ...
    data_train = data(train,(4:5));
    result_train = NPC(train);
    data_test = data(test,(4:5));
...
%     end
    ...
    t = RegressionTree.fit(data_train(index_skill,:),result_train(index_skill,:),'CategoricalPredictors',indicator);
    index_skill = data_test(:,1)==skills(id_skill);
    result_predict = predict(t, data_test(index_skill,:));
    residual = [residual;result_predict-result_test(index_skill,:)];
