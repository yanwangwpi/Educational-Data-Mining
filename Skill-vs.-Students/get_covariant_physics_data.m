...
% Input: MAT file from "preprocess..." script
...
source_name = {'fall2005','fall2006','fall2007','fall2008','fall2009',...
    'spring2006','spring2007','spring2008','spring2009','spring2010'};

for id_file = 1:length(source_name)
...
index = data(:,i_skill)~=data(:,i_skill) | data(:,i_order)~=data(:,i_order);
data = data(~index,:);
%% Preprocess data
...
for id_skill = 1:num_skills
    ...
    if num_students>=10 % Each skill has at least 0 students
...
save(strcat(source_name{id_file}), 'data_new');
end
