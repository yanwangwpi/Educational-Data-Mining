...
source_name = {'fall2005','fall2006','fall2007','fall2009',...
    'spring2006','spring2007','spring2008','spring2010'};
...
% 21~30 unimportant
C = textscan(fileID,'%d %s %s %s %s %d %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s','Delimiter','\t');
...
file_name = strcat(source_name{id_file},'_raw_data');
